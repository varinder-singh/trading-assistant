...
- **OI Clusters:** If the index is approaching a massive Call or Put Open Interest wall and shows signs of *absorbing* selling pressure (price bases near the wall instead of rejecting instantly), the Orchestrator anticipates a forced liquidation (squeeze).
