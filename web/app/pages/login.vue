  ...
  <div class="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-4 selection:bg-indigo-500/30">
    ...
    <div class="w-full max-w-md relative z-10">
      ...
      <div class="flex flex-col items-center mb-10 text-center">
        <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-indigo-500 to-indigo-600 flex items-center justify-center mb-6 shadow-lg shadow-indigo-500/25">
      ...
      <div class="bg-zinc-900/50 backdrop-blur-xl border border-zinc-800/50 rounded-3xl p-8 shadow-2xl">
        ...
        <div v-if="successMsg" class="mb-6 p-4 rounded-xl bg-green-500/10 border border-green-500/20 flex items-center gap-3">
        ...
        <div class="space-y-6 transition-all duration-300">
          <div>
            ...
            <p class="text-zinc-400 text-sm">{{ isSignUp ? 'Sign up to start trading' : 'Enter your credentials to access your account' }}</p>
          </div>
